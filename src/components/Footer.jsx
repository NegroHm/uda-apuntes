          ...
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6">
              <a 
                ...
                className="text-gray-300 dark:text-gray-400 hover:text-primary transition-colors text-sm break-all"
              >
              ...
              <a 
                ...
                className="flex items-center space-x-2 text-gray-300 dark:text-gray-400 hover:text-primary transition-colors text-sm flex-shrink-0"
              >
              ...
              <button className="flex items-center space-x-2 bg-yellow-600 hover:bg-yellow-700 text-white px-3 py-1 rounded-full text-sm transition-colors flex-shrink-0">
                <span>☕</span>
                <span>Apoyar</span>
              </button>
            </div>
